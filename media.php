...
<div class="row">
 <div class="col-lg-12" align="center">
  ...
  <div class="container" align="Right">
    ...
    <button type="button" class="btn btn-primary" onclick="location.href='mediaadd.php'" >新增相簿</button><hr>
   ...
   <tr>
     <td>
       ...
       <div class="col-md-3 img-portfoilo" align="center" >
         ...
         <div class="albuminfo" align="center"><a href="mediafix.php?id=<?php echo $row_RecAlbum["album_id"];?>"><h3 ><?php echo $row_RecAlbum["album_title"];?></h3></a>
